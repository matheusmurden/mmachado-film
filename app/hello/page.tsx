...
export default async function Hello() {
  ...
  return (
    <main className="h-[80vh] m-0 xl:w-screen xl:max-w-[100vw] p-10 px-6 pb-0 xl:pl-0 lg:pr-[10rem] mx-auto flex flex-col-reverse md:flex-row gap-8 xl:gap-16 items-center justify-center lg:justify-between">
